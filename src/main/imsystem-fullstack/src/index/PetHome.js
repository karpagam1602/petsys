    ...
    <><nav className="navbar navbar-expand-lg navbar-dark bg-secondary"
      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse mx " id="navbarSupportedContent">
          ...
          <div 
          // role='insertpetlink'
          ><Link className="btn btn-light btn-outline-dark mx" to="/addpet" id="insert">
          ...
          <div 
          // role='userlink'
          > <Link className="user btn btn-light btn-outline-dark mx" to="/user" id="tbn" name="btnUser" ><b>USER<ArrowRightIcon /></b></Link></div>
          <div
          //  role='applink'
           > <Link className="btn btn-light btn-outline-dark mx" to="/app" id="tbn" ><b>APPOINTMENT<ArrowRightIcon /></b></Link></div>
